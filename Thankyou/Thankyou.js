...
class thankyou {
    ...
    async thankyou (req,res) {
        ...
        * {
        ...
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><em>A following confirmation Email is coming your way, while you sit in silence feeling proud about yourself for taking a step in the right direction that your body will forever be grateful for ;)</em></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><em>If you have any questions or if we can further assist you in any way, please feel free to E-mail us at <strong>customercare@el-detox.com</strong>, or text us on our WhatsApp <strong>+97455333320.</strong></em></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><em>kindly check out our <strong>Instagram @eldetox.qtr</strong> for new deals and products update.</em></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><em>We are always glad to hear from you!</em></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><em>Thank you once again,</em></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><em>Yours Truely,</em></p>
        <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 140%;"><strong><em>El Detox Team</em></strong></p>
          </div>
