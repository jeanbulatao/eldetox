...
async Coupon(req,res)
{
    ...
    * {
    ...
    <p style="font-size: 14px; line-height: 140%;"><em><span style="font-family: 'times new roman', times; font-size: 14px; line-height: 19.6px;">Thank you for supporting us and starting your journey to detoxification. &nbsp;</span></em></p>
    <p style="font-size: 14px; line-height: 140%;"><em><span style="font-family: 'times new roman', times; font-size: 14px; line-height: 19.6px;">Congratulations! You have been picked to receive a discount on your next purchase. </span></em></p>
    <p style="font-size: 14px; line-height: 140%;"><em><span style="font-family: 'times new roman', times; font-size: 14px; line-height: 19.6px;">Please use this promo code <strong>`+ req.body.code + `</strong> to entitle you for a `+ req.body.percent +` discount on your next purchase.&nbsp;</span></em></p>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%; text-align: right;">.نود شكرك على دعمنا وبدء رحلتك في الاختيار الأفضل لبدنك و صحتك</p>
    <p dir="rtl" style="font-size: 14px; line-height: 140%; text-align: right;">تهانينا! لقد تم اختيارك للحصول على خصم لعملية شرائك التاليه من متجرنا.&nbsp; &nbsp; &nbsp;</p>
    <p dir="rtl" style="font-size: 14px; line-height: 140%; text-align: right;">رجى استخدام هذا الرمز الترويجي:</p>
    <p dir="rtl" style="font-size: 14px; line-height: 140%; text-align: right;">`+ req.body.code +` </p>
    <p dir="rtl" style="font-size: 14px; line-height: 140%; text-align: right;">للحصول على خصم `+ req.body.percentAr+` على عملية الشراء التالية</p>
    <p dir="rtl" style="font-size: 14px; line-height: 140%; text-align: right;">يرجى إدخال الرمز في مربع الرمز الترويجي قبل إتمام عملية الشراء كما هو مبين في الصورة.</p>
